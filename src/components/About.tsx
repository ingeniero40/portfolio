      ...
      <div className="max-w-5xl mx-auto px-6">
        <div className="flex flex-col items-center text-center space-y-16">
          ...
          <div className="space-y-4">
            ...
            <h3 className="text-4xl md:text-5xl font-bold tracking-tight max-w-2xl mx-auto">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-center">
            ...
            <div className="lg:col-span-5 relative mx-auto w-full max-w-sm lg:max-w-none">
              <div className="aspect-[4/5] rounded-2xl overflow-hidden grayscale hover:grayscale-0 transition-all duration-700 relative z-10 shadow-2xl">
                <Image 
              ...
              <div className="absolute -top-6 -left-6 bg-primary w-24 h-24 rounded-full flex items-center justify-center text-white font-bold text-center leading-tight z-20 shadow-2xl">
                Desde<br/>1993
              </div>
            </div>
